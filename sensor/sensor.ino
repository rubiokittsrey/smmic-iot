...
const char* ssid = "2E258";
const char* password = "!Nineteen8e5";
...
void loop() {
  ...
  if (now - lastMsg > 60000) {
    ...
    client.publish("/dev/test", "88"); //topic name (to which this ESP32 publishes its data). 88 is the dummy value.
